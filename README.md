...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=html,css,js,react,vite,nodejs,bootstrap,express,sass,postgres,redis,jest,docker,redux,aws,git,postman,linux,blender,ps,visualstudio,py)](https://skillicons.dev)
