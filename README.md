...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=html,css,js,react,vite,nodejs,bootstrap,express,sass,postgres,redis,jest,docker,aws,git,linux,postman,blender,ps,redux,visualstudio,py)](https://skillicons.dev)
