...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,react,vite,nodejs,express,bootstrap,tailwind,scss,postgres,redis,mongodb,jest,vitest,docker,redux,azure,aws,git,postman,linux,blender,ps,visualstudio,py,bash,terraform,nginx)](https://skillicons.dev)
